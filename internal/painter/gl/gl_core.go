...
func (c *coreContext) BindFramebuffer(target uint32, fbo uint32) {
	gl.BindFramebuffer(target, fbo)
}

func (c *coreContext) BlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1 int, mask, filter uint32) {
...
func (c *coreContext) DeleteFramebuffer(fbo uint32) {
	gl.DeleteFramebuffers(1, &fbo)
}

func (c *coreContext) FramebufferTexture2D(target, attachment, texTarget uint32, texture Texture, level int32) {
	gl.FramebufferTexture2D(target, attachment, texTarget, uint32(texture), level)
}

func (c *coreContext) GenFramebuffer() uint32 {
	var fbo uint32
